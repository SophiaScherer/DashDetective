...
/// <summary>
/// Split arithmetic for a weighted row: whether it still clears every child's minimum width, and how
/// it divides when it does. Used by <see cref="WidgetBoardLayout"/>, and kept separate from it so it
