...
/// <summary>Covers <see cref="GpuAdapter.FormatLuidToken"/>: the pure LUID→PDH-token formatting that
...
public class GpuAdapterProviderTests {
    ...
    public void FormatLuidToken_MatchesPdhInstanceTokenCasingAndWidth() {
        ...
        Assert.Equal("luid_0x00000000_0x0000e54b", GpuAdapter.FormatLuidToken(0, 0xE54B));
    }

    [Fact]
    public void FormatLuidToken_PadsBothPartsToEightHexDigits() {
        Assert.Equal("luid_0x00000001_0x000abcde", GpuAdapter.FormatLuidToken(1, 0xABCDE));
    }
    ...
    public void FormatLuidToken_FormatsNegativeHighPartAsUnsignedHex() {
        ...
        Assert.Equal("luid_0xffffffff_0x00000000", GpuAdapter.FormatLuidToken(-1, 0));
    }
}
