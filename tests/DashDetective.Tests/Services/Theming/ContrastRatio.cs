...
/// surface</b>, not a colour. <c>TextMuted</c> is white at 50% over <c>#141414</c>, so compositing has
...
internal static class ContrastRatio {
    ...
    /// Always ≥ 1, and ordered so the lighter colour is the numerator.</summary>
